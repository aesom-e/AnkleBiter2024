...
// A note is that this command was taken from the YAGSL configuration found at
// https://github.com/BroncBotz3481/YAGSL-Example/blob/main/src/main/java/frc/robot/commands/swervedrive/drivebase/AbsoluteFieldDrive.java
...
public class AbsoluteFieldDrive extends Command
{
  ...
  public void execute()
  {
    ...
    SmartDashboard.putNumber("[SWERVE] LimitedTranslation", translation.getX());
    SmartDashboard.putString("[SWERVE] Translation", translation.toString());
